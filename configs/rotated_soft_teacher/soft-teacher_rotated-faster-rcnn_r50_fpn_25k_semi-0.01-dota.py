...
model = dict(
    type='RotatedSoftTeacher',
    # type='RotatedSemiBaseDetector',
    detector=detector,
    data_preprocessor=dict(
...
labeled_dataset.ann_file = 'train/semi_anns/train.1@1.json'
unlabeled_dataset.ann_file = 'train/semi_anns/train.1@1-unlabeled.json'
unlabeled_dataset.data_prefix = dict(img='train/images/')
